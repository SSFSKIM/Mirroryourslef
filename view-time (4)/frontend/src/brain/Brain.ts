import {
  ...
  UploadWatchHistoryTakeoutError,
...
export class Brain<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  get_watch_history_status = (params: RequestParams = {}) =>
    this.request<GetWatchHistoryStatusData, any>({
      path: `/routes/status`,
      method: "GET",
      ...params,
    });
   ...
   */
  get_watch_history_analytics = (params: RequestParams = {}) =>
    this.request<GetWatchHistoryAnalyticsData, any>({
   ...
   */
  upload_watch_history_takeout = (data: BodyUploadWatchHistoryTakeout, params: RequestParams = {}) =>
    this.request<UploadWatchHistoryTakeoutData, UploadWatchHistoryTakeoutError>({
      path: `/routes/upload-takeout`,
      method: "POST",
      body: data,
   ...
   */
  delete_watch_history = (params: RequestParams = {}) =>
    this.request<DeleteWatchHistoryData, any>({
      path: `/routes/data`,
      method: "DELETE",
      ...params,
    });
