...
export const ViewingHeatmap: React.FC<ViewingHeatmapProps> = ({ className = "" }) => {
  ...
  return (
    <AnalyticsPanel
      eyebrow="Temporal Patterns"
      title="Viewing Heatmap"
      caption="When you watch most throughout the week"
      className={className}
    >
      {!hasHeatmap ? (
        <div className="empty-state flex h-40 items-center justify-center text-sm text-muted-foreground">
